...
if (isset($_POST['creer-topic'])){
    ...
    if($valid){
        ...
        header('Location: /SIFORUM/f_forum/sujet?id=' . $categorie);
        exit;
        }
    }
}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="cdr-ins">
                    ...
                    <form method="post" name="creer-topic" >
                    <?php
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="form-group">
                            ...
                            ?>  
                                <div class="form-group">
                                    <textarea class="form-control" row="3" placeholder="Décrivez votre topic" name="contenu"><?php if(isset($contenu)){ echo $contenu; }?></textarea>
                                </div>
                                <div class="form-group">
